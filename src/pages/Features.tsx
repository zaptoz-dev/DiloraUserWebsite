...
export default function Features() {
  const features = [
    ...
    { title: "10+ Indian & International Voices", desc: "Pick a voice and a language per campaign, or let Dialora detect the caller's language in the first two seconds and switch. Hindi, English, Tamil, Telugu, Kannada, Malayalam, Marathi, Gujarati, Odia, Bengali and more." },
